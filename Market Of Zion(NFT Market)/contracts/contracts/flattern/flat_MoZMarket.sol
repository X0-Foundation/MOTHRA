...
contract TheXdaoNFT is ERC721 {
	 ...
	 */
    function addItem(string memory _tokenURI, uint256 royalty) external returns (uint256){
...
contract TheXdaoMarket is Ownable, ERC721Holder {
	...
	uint256 constant public feeAdmin = 25;	
	...
	function initialize(
        ...
        createCollection("Public", "https://ipfs.io/ipfs/Qmb2xi5DHBbTj9QXKcvEdU8RphvLKL9ggUyH9kdAh7dbgG", true);		
	}    
    ...
    function delist(uint256 _id) external {        
        ...
        ITheXdaoNFT(pairs[_id].collection).safeTransferFrom(address(this), pairs[_id].owner, pairs[_id].token_id);        
