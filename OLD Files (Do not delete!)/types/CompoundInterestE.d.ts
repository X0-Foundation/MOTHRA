...
interface CompoundInterestEInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundInterestE extends BaseContract {
  ...
  interface: CompoundInterestEInterface;
