...
interface IKeep3rJobFundableCreditsInterface extends ethers.utils.Interface {
  functions: {
...
export class IKeep3rJobFundableCredits extends BaseContract {
  ...
  interface: IKeep3rJobFundableCreditsInterface;
