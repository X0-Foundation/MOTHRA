...
interface Keep3rJobDisputableInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rJobDisputable extends BaseContract {
  ...
  interface: Keep3rJobDisputableInterface;
