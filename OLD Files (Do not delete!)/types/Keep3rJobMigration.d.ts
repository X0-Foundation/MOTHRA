...
interface Keep3rJobMigrationInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rJobMigration extends BaseContract {
  ...
  interface: Keep3rJobMigrationInterface;
