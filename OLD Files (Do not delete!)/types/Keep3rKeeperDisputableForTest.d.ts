...
interface Keep3rKeeperDisputableForTestInterface
...
export class Keep3rKeeperDisputableForTest extends BaseContract {
  ...
  functions: {
    ...
    isKeeper(
      _address: string,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _isKeeper: boolean }>;
  ...
  isKeeper(_address: string, overrides?: CallOverrides): Promise<boolean>;
  ...
  estimateGas: {
    ...
    isKeeper(_address: string, overrides?: CallOverrides): Promise<BigNumber>;
