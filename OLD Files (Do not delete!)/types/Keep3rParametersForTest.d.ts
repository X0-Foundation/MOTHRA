...
interface Keep3rParametersForTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "viewIsKP3RToken0(address)": FunctionFragment;
    "viewLiquidityPool(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "viewIsKP3RToken0",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "viewLiquidityPool",
    values: [string]
  ): string;
  encodeFunctionData(
...
export class Keep3rParametersForTest extends BaseContract {
  ...
  interface: Keep3rParametersForTestInterface;
  ...
  viewIsKP3RToken0(_pool: string, overrides?: CallOverrides): Promise<boolean>;

  viewLiquidityPool(_pool: string, overrides?: CallOverrides): Promise<string>;
