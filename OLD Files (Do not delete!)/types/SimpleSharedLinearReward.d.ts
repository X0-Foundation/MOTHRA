...
interface SimpleSharedLinearRewardInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleSharedLinearReward extends BaseContract {
  ...
  interface: SimpleSharedLinearRewardInterface;
