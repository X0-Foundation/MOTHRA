...
interface UniV3PairManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class UniV3PairManager extends BaseContract {
  ...
  interface: UniV3PairManagerInterface;
