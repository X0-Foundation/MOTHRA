...
interface UniV3PairManagerForTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "internalAddLiquidity(uint256,uint256,uint256,uint256)": FunctionFragment;
    "internalBurn(address,uint256)": FunctionFragment;
    "internalMint(address,uint256)": FunctionFragment;
    "internalPay(address,address,address,uint256)": FunctionFragment;
    "internalSafeTransferFrom(address,address,address,uint256)": FunctionFragment;
    "internalTransferTokens(address,address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "internalAddLiquidity",
    values: [BigNumberish, BigNumberish, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "internalBurn",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "internalMint",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "internalPay",
    values: [string, string, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "internalSafeTransferFrom",
    values: [string, string, string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "internalTransferTokens",
...
export class UniV3PairManagerForTest extends BaseContract {
  ...
  interface: UniV3PairManagerForTestInterface;
