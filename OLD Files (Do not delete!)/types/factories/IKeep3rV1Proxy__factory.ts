...
export class IKeep3rV1Proxy__factory {
  static readonly abi = _abi;
  static createInterface(): IKeep3rV1ProxyInterface {
    return new utils.Interface(_abi) as IKeep3rV1ProxyInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IKeep3rV1Proxy {
    return new Contract(address, _abi, signerOrProvider) as IKeep3rV1Proxy;
  }
}
