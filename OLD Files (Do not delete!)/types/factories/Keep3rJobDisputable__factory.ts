...
import type {
  Keep3rJobDisputable,
  Keep3rJobDisputableInterface,
} from "../Keep3rJobDisputable";
...
export class Keep3rJobDisputable__factory {
  static readonly abi = _abi;
  static createInterface(): Keep3rJobDisputableInterface {
    return new utils.Interface(_abi) as Keep3rJobDisputableInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Keep3rJobDisputable {
    return new Contract(address, _abi, signerOrProvider) as Keep3rJobDisputable;
  }
}
