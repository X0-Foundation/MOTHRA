...
abstract contract Keep3rAccountance is IKeep3rAccountance {
  ...
  mapping(address => uint) public override workCompleted;

  /// @inheritdoc IKeep3rAccountance
  mapping(address => uint) public override firstSeen;
  ...
  mapping(address => mapping(address => uint)) public override bonds;

  /// @inheritdoc IKeep3rAccountance
  mapping(address => mapping(address => uint)) public override jobTokenCredits;

  /// @notice The current liquidity credits available for a job
  mapping(address => uint) internal _jobLiquidityCredits;

  /// @notice Map the address of a job to its correspondent periodCredits
  mapping(address => uint) internal _jobPeriodCredits;
  ...
  /// @inheritdoc IKeep3rAccountance
  mapping(address => mapping(address => uint)) public override pendingBonds;

  /// @inheritdoc IKeep3rAccountance
  mapping(address => mapping(address => uint)) public override canActivateAfter;

  /// @inheritdoc IKeep3rAccountance
  mapping(address => mapping(address => uint)) public override canWithdrawAfter;

  /// @inheritdoc IKeep3rAccountance
  mapping(address => mapping(address => uint)) public override pendingUnbonds;
