...
contract CompoundInterestE is Ownable {
    ...
    //==================== ERC20 core data ====================
    string private constant _name = "CompoundInterestE";
    string private constant _symbol = "CERWE";
    ...
    function upadateWithTotalShare() public {
        ...
        if (missings > 0) {
            ...
            uint pending = IntegralMath.mulDivF(_totalSupply, p, q) - _totalSupply;
            rewardPool += pending;
            // accRewardPerShare12 += (IntegralMath.mulDivF(1e12, p, q) - 1e12);
            accRewardPerShare12 += (IntegralMath.mulDivC(1e12, p, q) - 1e12);
    ...
    function _changeUserShare(address user, uint amount, bool CreditNotDebit) internal {
        ...
        users[user].rewardDebt = IntegralMath.mulDivC(accRewardPerShare12, _balances[user], 1e12);
    }
