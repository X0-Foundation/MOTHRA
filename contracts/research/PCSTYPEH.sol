...
contract PCSTypeH is Ownable {
    ...
    //==================== ERC20 core data ====================
    string private constant _name = "PCSTypeH";
    string private constant _symbol = "TP_H";
    ...
    function _changeUserShare(address user, uint amount, bool CreditNotDebit) internal {
        ...
        // These two lines, replacing the above commented-out line, implement PCSTypeG.
