...
//=====================================================================================
// Non-compounding Linear Reward.
// rewards[user] += _rate * blocks_passed * _balances[user]
//=====================================================================================

contract PCSTypeC is Ownable {
    ...
    //==================== ERC20 core data ====================
    string private constant _name = "PCSTypeC";
    string private constant _symbol = "TP_C";
