...
interface CompoundExpRewardInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundExpReward extends BaseContract {
  ...
  interface: CompoundExpRewardInterface;
