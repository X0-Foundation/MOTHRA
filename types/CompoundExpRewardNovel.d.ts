...
interface CompoundExpRewardNovelInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundExpRewardNovel extends BaseContract {
  ...
  interface: CompoundExpRewardNovelInterface;
