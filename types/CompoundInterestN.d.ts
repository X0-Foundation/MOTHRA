...
interface CompoundInterestNInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundInterestN extends BaseContract {
  ...
  interface: CompoundInterestNInterface;
