...
interface IPairManagerFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class IPairManagerFactory extends BaseContract {
  ...
  interface: IPairManagerFactoryInterface;
  ...
  functions: {
    ...
    pairManagers(
      _pool: string,
      overrides?: CallOverrides
    ): Promise<[string] & { _pairManager: string }>;
  ...
  pairManagers(_pool: string, overrides?: CallOverrides): Promise<string>;
  ...
  estimateGas: {
    ...
    pairManagers(_pool: string, overrides?: CallOverrides): Promise<BigNumber>;
