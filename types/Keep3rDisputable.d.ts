...
interface Keep3rDisputableInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rDisputable extends BaseContract {
  ...
  interface: Keep3rDisputableInterface;
