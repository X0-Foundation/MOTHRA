...
interface Keep3rHelperParametersInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rHelperParameters extends BaseContract {
  ...
  interface: Keep3rHelperParametersInterface;
