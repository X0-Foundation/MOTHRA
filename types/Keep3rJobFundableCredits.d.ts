...
interface Keep3rJobFundableCreditsInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rJobFundableCredits extends BaseContract {
  ...
  interface: Keep3rJobFundableCreditsInterface;
