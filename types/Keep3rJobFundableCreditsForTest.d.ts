...
interface Keep3rJobFundableCreditsForTestInterface
  ...
  functions: {
    ...
    "isJobToken(address,address)": FunctionFragment;
    ...
    "setJob(address,address)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "isJobToken", data: BytesLike): Result;
...
export class Keep3rJobFundableCreditsForTest extends BaseContract {
  ...
  functions: {
    ...
    isJobToken(
      ...
      _token: string,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _contains: boolean }>;
