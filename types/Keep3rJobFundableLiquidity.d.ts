...
interface Keep3rJobFundableLiquidityInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rJobFundableLiquidity extends BaseContract {
  ...
  interface: Keep3rJobFundableLiquidityInterface;
