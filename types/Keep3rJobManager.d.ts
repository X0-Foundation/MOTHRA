...
interface Keep3rJobManagerInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rJobManager extends BaseContract {
  ...
  interface: Keep3rJobManagerInterface;
