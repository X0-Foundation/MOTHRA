...
interface Keep3rJobManagerForTestInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rJobManagerForTest extends BaseContract {
  ...
  interface: Keep3rJobManagerForTestInterface;
  ...
  functions: {
    ...
    isJob(
      _job: string,
      overrides?: CallOverrides
    ): Promise<[boolean] & { _isJob: boolean }>;
