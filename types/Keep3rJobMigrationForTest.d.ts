...
interface Keep3rJobMigrationForTestInterface extends ethers.utils.Interface {
  functions: {
    ...
    "isJob(address)": FunctionFragment;
    ...
    "setJobToken(address,address)": FunctionFragment;
    ...
    "settleJobAccountanceCallCount(address)": FunctionFragment;
    ...
    "viewJobLiquidityList(address)": FunctionFragment;
    "viewJobPeriodCredits(address)": FunctionFragment;
    "viewJobTokenListLength(address)": FunctionFragment;
    "viewMigrationCreatedAt(address,address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "isJob", values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "settleJobAccountanceCallCount",
    values: [string]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "viewJobLiquidityList",
    values: [string]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "viewJobTokenListLength",
    values: [string]
  ): string;
  encodeFunctionData(
    functionFragment: "viewMigrationCreatedAt",
    values: [string, string]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "isJob", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "jobLiquidityCredits",
    data: BytesLike
  ): Result;
...
export class Keep3rJobMigrationForTest extends BaseContract {
  ...
  interface: Keep3rJobMigrationForTestInterface;
  ...
  functions: {
    ...
    isJob(_job: string, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    viewJobTokenListLength(
      _job: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;

    viewMigrationCreatedAt(
      _fromJob: string,
      _toJob: string,
      overrides?: CallOverrides
    ): Promise<[BigNumber]>;
  ...
  estimateGas: {
    ...
    isJob(_job: string, overrides?: CallOverrides): Promise<BigNumber>;
