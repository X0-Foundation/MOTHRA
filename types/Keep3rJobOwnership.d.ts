...
interface Keep3rJobOwnershipInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rJobOwnership extends BaseContract {
  ...
  interface: Keep3rJobOwnershipInterface;
