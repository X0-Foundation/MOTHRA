...
interface Keep3rJobWorkableInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rJobWorkable extends BaseContract {
  ...
  interface: Keep3rJobWorkableInterface;
