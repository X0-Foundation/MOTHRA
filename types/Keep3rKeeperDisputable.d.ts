...
interface Keep3rKeeperDisputableInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rKeeperDisputable extends BaseContract {
  ...
  interface: Keep3rKeeperDisputableInterface;
