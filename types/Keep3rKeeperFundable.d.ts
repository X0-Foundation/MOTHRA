...
interface Keep3rKeeperFundableInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rKeeperFundable extends BaseContract {
  ...
  interface: Keep3rKeeperFundableInterface;
