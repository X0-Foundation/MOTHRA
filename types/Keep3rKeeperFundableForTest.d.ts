...
interface Keep3rKeeperFundableForTestInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rKeeperFundableForTest extends BaseContract {
  ...
  interface: Keep3rKeeperFundableForTestInterface;
