...
interface Keep3rParametersInterface extends ethers.utils.Interface {
  functions: {
...
export class Keep3rParameters extends BaseContract {
  ...
  interface: Keep3rParametersInterface;
