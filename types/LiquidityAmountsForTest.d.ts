...
interface LiquidityAmountsForTestInterface extends ethers.utils.Interface {
  functions: {
...
export class LiquidityAmountsForTest extends BaseContract {
  ...
  interface: LiquidityAmountsForTestInterface;
