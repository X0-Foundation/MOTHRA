...
interface SimpleExpRewardNovelInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleExpRewardNovel extends BaseContract {
  ...
  interface: SimpleExpRewardNovelInterface;
