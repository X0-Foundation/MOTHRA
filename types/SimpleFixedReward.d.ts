...
interface SimpleFixedRewardInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleFixedReward extends BaseContract {
  ...
  interface: SimpleFixedRewardInterface;
