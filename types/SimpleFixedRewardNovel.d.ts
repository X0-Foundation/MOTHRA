...
interface SimpleFixedRewardNovelInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleFixedRewardNovel extends BaseContract {
  ...
  interface: SimpleFixedRewardNovelInterface;
