...
interface SimpleLinearRewardInterface extends ethers.utils.Interface {
  functions: {
...
export class SimpleLinearReward extends BaseContract {
  ...
  interface: SimpleLinearRewardInterface;
