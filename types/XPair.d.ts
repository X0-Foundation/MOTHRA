...
interface XPairInterface extends ethers.utils.Interface {
  functions: {
    ...
    "sim_burn(uint256)": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "sim_burn", data: BytesLike): Result;
...
export class XPair extends BaseContract {
