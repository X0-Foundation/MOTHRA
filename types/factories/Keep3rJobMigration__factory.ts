...
import type {
  Keep3rJobMigration,
  Keep3rJobMigrationInterface,
} from "../Keep3rJobMigration";
...
export class Keep3rJobMigration__factory {
  static readonly abi = _abi;
  static createInterface(): Keep3rJobMigrationInterface {
    return new utils.Interface(_abi) as Keep3rJobMigrationInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Keep3rJobMigration {
    return new Contract(address, _abi, signerOrProvider) as Keep3rJobMigration;
  }
}
