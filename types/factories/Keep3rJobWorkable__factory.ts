...
import type {
  Keep3rJobWorkable,
  Keep3rJobWorkableInterface,
} from "../Keep3rJobWorkable";
...
export class Keep3rJobWorkable__factory {
  static readonly abi = _abi;
  static createInterface(): Keep3rJobWorkableInterface {
    return new utils.Interface(_abi) as Keep3rJobWorkableInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Keep3rJobWorkable {
    return new Contract(address, _abi, signerOrProvider) as Keep3rJobWorkable;
  }
}
