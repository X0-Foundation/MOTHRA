...
import type { Keep3rJobs, Keep3rJobsInterface } from "../Keep3rJobs";
...
export class Keep3rJobs__factory {
  static readonly abi = _abi;
  static createInterface(): Keep3rJobsInterface {
    return new utils.Interface(_abi) as Keep3rJobsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Keep3rJobs {
    return new Contract(address, _abi, signerOrProvider) as Keep3rJobs;
  }
}
