...
import type {
  ...
  Keep3rKeeperDisputableInterface,
} from "../Keep3rKeeperDisputable";
...
export class Keep3rKeeperDisputable__factory {
  static readonly abi = _abi;
  static createInterface(): Keep3rKeeperDisputableInterface {
    return new utils.Interface(_abi) as Keep3rKeeperDisputableInterface;
  }
  static connect(
    address: string,
