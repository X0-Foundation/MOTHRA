...
import type {
  ...
  Keep3rKeeperFundableInterface,
} from "../Keep3rKeeperFundable";
...
export class Keep3rKeeperFundable__factory {
  static readonly abi = _abi;
  static createInterface(): Keep3rKeeperFundableInterface {
    return new utils.Interface(_abi) as Keep3rKeeperFundableInterface;
  }
  static connect(
    address: string,
