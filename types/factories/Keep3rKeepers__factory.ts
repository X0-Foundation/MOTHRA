...
import type { Keep3rKeepers, Keep3rKeepersInterface } from "../Keep3rKeepers";
...
export class Keep3rKeepers__factory {
  static readonly abi = _abi;
  static createInterface(): Keep3rKeepersInterface {
    return new utils.Interface(_abi) as Keep3rKeepersInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): Keep3rKeepers {
    return new Contract(address, _abi, signerOrProvider) as Keep3rKeepers;
  }
}
